...
The default parser delegates BebeLM's bracketed Pythonic tool-call form to
upstream, including multiple calls. JSON object calls remain optional legacy
compatibility when `jsonlite` is installed.
