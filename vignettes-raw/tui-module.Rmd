...
a portable braille thumbnail from the PNG bytes so thin base-R axes/points survive
...
sixel), while a jgd-style graphics stream would be the richer vector/event
