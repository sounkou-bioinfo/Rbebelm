...
typedef SEXP (*fn_029)(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
static fn_029 p_029 = NULL;
typedef SEXP (*fn_030)(SEXP, SEXP);
static fn_030 p_030 = NULL;
typedef SEXP (*fn_031)(SEXP, SEXP, SEXP, SEXP, SEXP);
static fn_031 p_031 = NULL;
typedef SEXP (*fn_032)(SEXP, SEXP, SEXP);
static fn_032 p_032 = NULL;
typedef SEXP (*fn_033)(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
static fn_033 p_033 = NULL;
typedef SEXP (*fn_034)(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
static fn_034 p_034 = NULL;
typedef SEXP (*fn_035)(SEXP);
static fn_035 p_035 = NULL;
typedef SEXP (*fn_036)(SEXP, SEXP);
...
static void bind_static_backend_symbols(void) {
    ...
    p_026 = (fn_026)savvy_BebelAsyncJob_ready__ffi;
    p_027 = (fn_027)savvy_BebelAsyncJob_result__ffi;
    p_028 = (fn_028)savvy_BebelModel_chat__ffi;
    p_029 = (fn_029)savvy_BebelModel_chat_async__ffi;
    p_030 = (fn_030)savvy_BebelModel_decode__ffi;
    p_031 = (fn_031)savvy_BebelModel_embed__ffi;
    p_032 = (fn_032)savvy_BebelModel_encode__ffi;
    p_033 = (fn_033)savvy_BebelModel_generate__ffi;
    p_034 = (fn_034)savvy_BebelModel_generate_async__ffi;
    p_035 = (fn_035)savvy_BebelModel_info__ffi;
    p_036 = (fn_036)savvy_BebelModel_load__ffi;
}
#endif
...
static int try_load_backend(const char *backend, char *err, size_t err_size) {
    ...
    p_026 = (fn_026)load_symbol(handle, "savvy_BebelAsyncJob_ready__ffi");
    p_027 = (fn_027)load_symbol(handle, "savvy_BebelAsyncJob_result__ffi");
    p_028 = (fn_028)load_symbol(handle, "savvy_BebelModel_chat__ffi");
    p_029 = (fn_029)load_symbol(handle, "savvy_BebelModel_chat_async__ffi");
    p_030 = (fn_030)load_symbol(handle, "savvy_BebelModel_decode__ffi");
    p_031 = (fn_031)load_symbol(handle, "savvy_BebelModel_embed__ffi");
    p_032 = (fn_032)load_symbol(handle, "savvy_BebelModel_encode__ffi");
    p_033 = (fn_033)load_symbol(handle, "savvy_BebelModel_generate__ffi");
    p_034 = (fn_034)load_symbol(handle, "savvy_BebelModel_generate_async__ffi");
    p_035 = (fn_035)load_symbol(handle, "savvy_BebelModel_info__ffi");
    p_036 = (fn_036)load_symbol(handle, "savvy_BebelModel_load__ffi");
...
SEXP Rbebelm_BebelAsyncJob_ready_ffi(SEXP self__) { Rbebelm_init_backend(); return p_026(self__); }
SEXP Rbebelm_BebelAsyncJob_result_ffi(SEXP self__, SEXP c_arg__wait) { Rbebelm_init_backend(); return p_027(self__, c_arg__wait); }
SEXP Rbebelm_BebelModel_chat_ffi(SEXP self__, SEXP c_arg__message, SEXP c_arg__greedy, SEXP c_arg__check_interrupt, SEXP c_arg__on_event, SEXP c_arg__max_gen, SEXP c_arg__max_context, SEXP c_arg__max_think, SEXP c_arg__temperature, SEXP c_arg__top_k, SEXP c_arg__repeat_penalty) { Rbebelm_init_backend(); return p_028(self__, c_arg__message, c_arg__greedy, c_arg__check_interrupt, c_arg__on_event, c_arg__max_gen, c_arg__max_context, c_arg__max_think, c_arg__temperature, c_arg__top_k, c_arg__repeat_penalty); }
SEXP Rbebelm_BebelModel_chat_async_ffi(SEXP self__, SEXP c_arg__message, SEXP c_arg__greedy, SEXP c_arg__max_gen, SEXP c_arg__max_context, SEXP c_arg__max_think, SEXP c_arg__temperature, SEXP c_arg__top_k, SEXP c_arg__repeat_penalty) { Rbebelm_init_backend(); return p_029(self__, c_arg__message, c_arg__greedy, c_arg__max_gen, c_arg__max_context, c_arg__max_think, c_arg__temperature, c_arg__top_k, c_arg__repeat_penalty); }
SEXP Rbebelm_BebelModel_decode_ffi(SEXP self__, SEXP c_arg__ids) { Rbebelm_init_backend(); return p_030(self__, c_arg__ids); }
SEXP Rbebelm_BebelModel_embed_ffi(SEXP self__, SEXP c_arg__text, SEXP c_arg__add_bos, SEXP c_arg__normalize, SEXP c_arg__pooling) { Rbebelm_init_backend(); return p_031(self__, c_arg__text, c_arg__add_bos, c_arg__normalize, c_arg__pooling); }
SEXP Rbebelm_BebelModel_encode_ffi(SEXP self__, SEXP c_arg__text, SEXP c_arg__add_bos) { Rbebelm_init_backend(); return p_032(self__, c_arg__text, c_arg__add_bos); }
SEXP Rbebelm_BebelModel_generate_ffi(SEXP self__, SEXP c_arg__prompt, SEXP c_arg__greedy, SEXP c_arg__check_interrupt, SEXP c_arg__on_event, SEXP c_arg__max_gen, SEXP c_arg__max_context, SEXP c_arg__max_think, SEXP c_arg__temperature, SEXP c_arg__top_k, SEXP c_arg__repeat_penalty) { Rbebelm_init_backend(); return p_033(self__, c_arg__prompt, c_arg__greedy, c_arg__check_interrupt, c_arg__on_event, c_arg__max_gen, c_arg__max_context, c_arg__max_think, c_arg__temperature, c_arg__top_k, c_arg__repeat_penalty); }
SEXP Rbebelm_BebelModel_generate_async_ffi(SEXP self__, SEXP c_arg__prompt, SEXP c_arg__greedy, SEXP c_arg__max_gen, SEXP c_arg__max_context, SEXP c_arg__max_think, SEXP c_arg__temperature, SEXP c_arg__top_k, SEXP c_arg__repeat_penalty) { Rbebelm_init_backend(); return p_034(self__, c_arg__prompt, c_arg__greedy, c_arg__max_gen, c_arg__max_context, c_arg__max_think, c_arg__temperature, c_arg__top_k, c_arg__repeat_penalty); }
SEXP Rbebelm_BebelModel_info_ffi(SEXP self__) { Rbebelm_init_backend(); return p_035(self__); }
SEXP Rbebelm_BebelModel_load_ffi(SEXP c_arg__path, SEXP c_arg__num_threads) { Rbebelm_init_backend(); return p_036(c_arg__path, c_arg__num_threads); }
