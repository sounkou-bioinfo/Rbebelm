...
typedef SEXP (*fn_006)(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
static fn_006 p_006 = NULL;
typedef SEXP (*fn_007)(SEXP, SEXP);
static fn_007 p_007 = NULL;
typedef SEXP (*fn_008)(SEXP, SEXP);
static fn_008 p_008 = NULL;
typedef SEXP (*fn_009)(SEXP, SEXP, SEXP, SEXP);
...
typedef SEXP (*fn_024)(SEXP, SEXP, SEXP);
static fn_024 p_024 = NULL;
typedef SEXP (*fn_025)(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
...
static void bind_static_backend_symbols(void) {
    ...
    p_006 = (fn_006)savvy_rbebelm_tool_schema_json__ffi;
    p_007 = (fn_007)savvy_BebelAgent_append__ffi;
    p_008 = (fn_008)savvy_BebelAgent_append_system__ffi;
    p_009 = (fn_009)savvy_BebelAgent_append_system_with_tools__ffi;
    p_010 = (fn_010)savvy_BebelAgent_append_tokens__ffi;
    p_011 = (fn_011)savvy_BebelAgent_append_tool_result__ffi;
    p_012 = (fn_012)savvy_BebelAgent_append_user__ffi;
    p_013 = (fn_013)savvy_BebelAgent_assistant_turn__ffi;
    p_014 = (fn_014)savvy_BebelAgent_assistant_turn_tool_stop__ffi;
    p_015 = (fn_015)savvy_BebelAgent_clear__ffi;
    ...
    p_021 = (fn_021)savvy_BebelAgent_transcript__ffi;
    p_022 = (fn_022)savvy_BebelModel_chat__ffi;
    p_023 = (fn_023)savvy_BebelModel_decode__ffi;
    p_024 = (fn_024)savvy_BebelModel_encode__ffi;
    p_025 = (fn_025)savvy_BebelModel_generate__ffi;
    p_026 = (fn_026)savvy_BebelModel_info__ffi;
    p_027 = (fn_027)savvy_BebelModel_load__ffi;
}
#endif
...
static int try_load_backend(const char *backend, char *err, size_t err_size) {
    ...
    p_006 = (fn_006)load_symbol(handle, "savvy_rbebelm_tool_schema_json__ffi");
    p_007 = (fn_007)load_symbol(handle, "savvy_BebelAgent_append__ffi");
    p_008 = (fn_008)load_symbol(handle, "savvy_BebelAgent_append_system__ffi");
    p_009 = (fn_009)load_symbol(handle, "savvy_BebelAgent_append_system_with_tools__ffi");
    p_010 = (fn_010)load_symbol(handle, "savvy_BebelAgent_append_tokens__ffi");
    p_011 = (fn_011)load_symbol(handle, "savvy_BebelAgent_append_tool_result__ffi");
    p_012 = (fn_012)load_symbol(handle, "savvy_BebelAgent_append_user__ffi");
    p_013 = (fn_013)load_symbol(handle, "savvy_BebelAgent_assistant_turn__ffi");
    p_014 = (fn_014)load_symbol(handle, "savvy_BebelAgent_assistant_turn_tool_stop__ffi");
    p_015 = (fn_015)load_symbol(handle, "savvy_BebelAgent_clear__ffi");
    ...
    p_021 = (fn_021)load_symbol(handle, "savvy_BebelAgent_transcript__ffi");
    p_022 = (fn_022)load_symbol(handle, "savvy_BebelModel_chat__ffi");
    p_023 = (fn_023)load_symbol(handle, "savvy_BebelModel_decode__ffi");
    p_024 = (fn_024)load_symbol(handle, "savvy_BebelModel_encode__ffi");
    p_025 = (fn_025)load_symbol(handle, "savvy_BebelModel_generate__ffi");
    p_026 = (fn_026)load_symbol(handle, "savvy_BebelModel_info__ffi");
    p_027 = (fn_027)load_symbol(handle, "savvy_BebelModel_load__ffi");
...
SEXP Rbebelm_tool_schema_json_ffi(SEXP c_arg__name, SEXP c_arg__description, SEXP c_arg__param_names, SEXP c_arg__param_types, SEXP c_arg__param_descriptions, SEXP c_arg__param_required) { Rbebelm_init_backend(); return p_006(c_arg__name, c_arg__description, c_arg__param_names, c_arg__param_types, c_arg__param_descriptions, c_arg__param_required); }
SEXP Rbebelm_BebelAgent_append_ffi(SEXP self__, SEXP c_arg__text) { Rbebelm_init_backend(); return p_007(self__, c_arg__text); }
SEXP Rbebelm_BebelAgent_append_system_ffi(SEXP self__, SEXP c_arg__message) { Rbebelm_init_backend(); return p_008(self__, c_arg__message); }
SEXP Rbebelm_BebelAgent_append_system_with_tools_ffi(SEXP self__, SEXP c_arg__message, SEXP c_arg__tool_names, SEXP c_arg__tool_schemas) { Rbebelm_init_backend(); return p_009(self__, c_arg__message, c_arg__tool_names, c_arg__tool_schemas); }
SEXP Rbebelm_BebelAgent_append_tokens_ffi(SEXP self__, SEXP c_arg__ids) { Rbebelm_init_backend(); return p_010(self__, c_arg__ids); }
SEXP Rbebelm_BebelAgent_append_tool_result_ffi(SEXP self__, SEXP c_arg__content) { Rbebelm_init_backend(); return p_011(self__, c_arg__content); }
SEXP Rbebelm_BebelAgent_append_user_ffi(SEXP self__, SEXP c_arg__message) { Rbebelm_init_backend(); return p_012(self__, c_arg__message); }
SEXP Rbebelm_BebelAgent_assistant_turn_ffi(SEXP self__, SEXP c_arg__check_interrupt, SEXP c_arg__on_event) { Rbebelm_init_backend(); return p_013(self__, c_arg__check_interrupt, c_arg__on_event); }
...
SEXP Rbebelm_BebelAgent_clear_ffi(SEXP self__) { Rbebelm_init_backend(); return p_015(self__); }
...
SEXP Rbebelm_BebelAgent_transcript_ffi(SEXP self__) { Rbebelm_init_backend(); return p_021(self__); }
SEXP Rbebelm_BebelModel_chat_ffi(SEXP self__, SEXP c_arg__message, SEXP c_arg__greedy, SEXP c_arg__check_interrupt, SEXP c_arg__on_event, SEXP c_arg__max_gen, SEXP c_arg__max_context, SEXP c_arg__max_think, SEXP c_arg__temperature, SEXP c_arg__top_k, SEXP c_arg__repeat_penalty) { Rbebelm_init_backend(); return p_022(self__, c_arg__message, c_arg__greedy, c_arg__check_interrupt, c_arg__on_event, c_arg__max_gen, c_arg__max_context, c_arg__max_think, c_arg__temperature, c_arg__top_k, c_arg__repeat_penalty); }
SEXP Rbebelm_BebelModel_decode_ffi(SEXP self__, SEXP c_arg__ids) { Rbebelm_init_backend(); return p_023(self__, c_arg__ids); }
SEXP Rbebelm_BebelModel_encode_ffi(SEXP self__, SEXP c_arg__text, SEXP c_arg__add_bos) { Rbebelm_init_backend(); return p_024(self__, c_arg__text, c_arg__add_bos); }
SEXP Rbebelm_BebelModel_generate_ffi(SEXP self__, SEXP c_arg__prompt, SEXP c_arg__greedy, SEXP c_arg__check_interrupt, SEXP c_arg__on_event, SEXP c_arg__max_gen, SEXP c_arg__max_context, SEXP c_arg__max_think, SEXP c_arg__temperature, SEXP c_arg__top_k, SEXP c_arg__repeat_penalty) { Rbebelm_init_backend(); return p_025(self__, c_arg__prompt, c_arg__greedy, c_arg__check_interrupt, c_arg__on_event, c_arg__max_gen, c_arg__max_context, c_arg__max_think, c_arg__temperature, c_arg__top_k, c_arg__repeat_penalty); }
SEXP Rbebelm_BebelModel_info_ffi(SEXP self__) { Rbebelm_init_backend(); return p_026(self__); }
SEXP Rbebelm_BebelModel_load_ffi(SEXP c_arg__path, SEXP c_arg__num_threads) { Rbebelm_init_backend(); return p_027(c_arg__path, c_arg__num_threads); }
