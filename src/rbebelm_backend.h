...
SEXP Rbebelm_BebelFileFinder_info_ffi(SEXP self__);
SEXP Rbebelm_BebelFileFinder_new_ffi(SEXP c_arg__base_path, SEXP c_arg__frecency_db_path, SEXP c_arg__history_db_path, SEXP c_arg__enable_mmap_cache, SEXP c_arg__enable_content_indexing, SEXP c_arg__watch, SEXP c_arg__ai_mode, SEXP c_arg__wait_timeout_ms);
SEXP Rbebelm_BebelFileFinder_search_ffi(SEXP self__, SEXP c_arg__query, SEXP c_arg__current_file, SEXP c_arg__max_threads, SEXP c_arg__offset, SEXP c_arg__limit, SEXP c_arg__combo_boost_score_multiplier, SEXP c_arg__min_combo_count, SEXP c_arg__wait_timeout_ms);
SEXP Rbebelm_BebelFileFinder_wait_ffi(SEXP self__, SEXP c_arg__timeout_ms);
